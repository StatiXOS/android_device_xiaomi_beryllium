...
LOCAL_MODULE := android.hardware.power-service.beryllium-libperfmgr
LOCAL_INIT_RC := android.hardware.power-service.beryllium-libperfmgr.rc
LOCAL_MODULE_TAGS := optional
LOCAL_VENDOR_MODULE := true
LOCAL_VINTF_FRAGMENTS := android.hardware.power-service.beryllium.xml
